...
<div>
		<div>
			...
			<div style="text-align:center; margin-top: 15%; margin-bottom: 100px;">
				...
				<div class="fpw">
				<form id="frm" action="/flower/findPwResult" method="POST">
					...
					<div>
						<label> 이  름 </label> 
						<span class="box"><input type="text" class="int" maxlength="30" name="user_name" id="user_name" placeholder="등록한 이름을 쓰시오."></span>
					</div>
					<div>
						<label> 이메일 </label> 
